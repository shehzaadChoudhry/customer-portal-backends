...
public class JwtTokenUtil {
	...
	public String generateTokenFromUserId(Authentication userDetails, String tokenType, String platform) {
		...
		if(platform.equals("web")) {
		 ...
		 if (CommonUtil.REFRESH_HEADER.equals(tokenType)) {
			 ...
			 expiryTime = new Date((new Date()).getTime() + TimeUnit.MINUTES.toMillis(CommonUtil.JWT_EXPIRY_MIN_ANDROID	));
		}
